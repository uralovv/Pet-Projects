                ...
                <div class="card-body">
                    <form method="POST" action="/admin/students">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="student_id" type="text" class="form-control @error('student_id') is-invalid @enderror" name="student_id" value="{{$data['student_id']}}" required autocomplete="student_id" autofocus>
